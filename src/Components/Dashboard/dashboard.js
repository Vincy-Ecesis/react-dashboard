...
import ReactPopperTooltip from '../Tooltip/tooltip';
...
const Dashboard = () => {
    ...
    const CustomProgressBar = ({ name, percent, tooltip }) => (
        <div className="progress-container">
            ...
            {/* <ReactPopperTooltip content="Hello Popper!">
    ...
    const state = {
        ...
        options: {
            ...
            legend: {
                ...
                // offsetY: 10, // Adjust the vertical position of the legend
                // markers: {
                //   radius: 12, // Adjust the size of the legend markers
                // },
                // itemMargin: {
                //   horizontal: 0, // Set to 0 to display items one by one
                //   vertical: 5,   // Adjust the vertical margin between items
                // },
            },
            responsive: [
                {
